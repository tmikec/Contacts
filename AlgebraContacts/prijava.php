<?php
	...
	class Prijava extends Page
	{
		protected function GetContent()
		{
			...
			$output .= '<tr><th>Zaporka:</th><td><input class="form-control" type="password" name="pw"/></td></tr>';
			$output .= '<tr><th></th><td><input type="submit" class="btn btn-info" name="btnSub" value="Prijavi se"/></td></tr>';
			$output .= '</table>';
			$output .= '</form>';
